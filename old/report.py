...
def format_excel_file(file_path, sheet_name, config):
    ...
    try:
        ...
        # Финансовый формат для числовых колонок
        financial_cols = {'B': 'Бонусов начислено', 'C': 'Продано литров', 'D': 'Бонусов списано'}
        ...
        # Формат для колонки E (На 1 литр начислено бонусов)
...
def main():
    ...
    try:
        ...
        print(f"⛽ Продано литров: {df_report['Продано литров с начислением бонусов'].iloc[-1]:,.2f}")
